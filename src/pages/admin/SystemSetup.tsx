      ...
      <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='mb-8'>
          ...
          <p className='text-gray-600'>
            Initialize VENVL with default users and demo data automatically
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              ...
              <Alert>
                ...
                <AlertDescription>
                  <strong>Clear All Data:</strong> Removes all users,
                  properties, bookings, and reviews from the database.
                  <br />
                  <strong>Initialize System + Demo Data:</strong> Creates
                  default users (super admin, host, guest) and automatically
                  seeds demo properties, bookings, and reviews.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
              ...
              <CardContent>
                <div className='space-y-4'>
                  ...
                  {initializationResult.users_created !== undefined && (
                    <div className='flex items-center justify-between'>
                      ...
                      <Badge variant='secondary'>
                        {initializationResult.users_created}
                      </Badge>
                    </div>
                  )}
                  ...
                  {initializationResult.results &&
                    initializationResult.results.length > 0 && (
                      <div>
                        <span className='font-medium'>
                          User Creation Details:
                        </span>
                        <div className='mt-2 space-y-2'>
                          {initializationResult.results.map(
                            (result, index: number) => (
                              <div
                                key={index}
