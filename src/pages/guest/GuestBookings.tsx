...
const GuestBookings = () => {
  ...
  const canCancel = (booking: Booking) => {
    ...
    return ['pending', 'confirmed'].includes(booking.status) && checkInDate > today;
  };

  const canReview = (booking: Booking) => {
    return booking.status === 'completed' && !reviews.some(r => r.booking_id === booking.id);
  };
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">Manage your reservations and reviews</p>
          </div>
        </div>
            ...
            {reviews.length === 0 ? (
              <Card>
                <CardContent className="flex flex-col items-center justify-center py-12">
                  ...
                  <p className="text-gray-600">Complete your stays to leave reviews</p>
                </CardContent>
              </Card>
            ) : (
              <div className="space-y-4">
                    ...
                    <CardContent className="p-6">
                      <div className="flex gap-4">
                        <div className="aspect-square w-16 h-16 rounded-lg overflow-hidden">
                          <img
                            src={review.property?.images?.[0] || '/placeholder.svg'}
