...
import { Bell, Check, X, MessageSquare, AlertTriangle, Info, CheckCircle } from 'lucide-react';
...
const NotificationCenter = ({ userId }: NotificationCenterProps) => {
  ...
  const loadNotifications = async () => {
    try {
      ...
      const { data, error } = await supabase.functions.invoke('realtime-notifications', {
        method: 'GET',
