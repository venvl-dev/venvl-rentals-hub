    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
          ...
          {/* Dates */}
          <motion.div
            className={`lg:col-span-2 p-6 cursor-pointer transition-all duration-300 ${
              activeSection === 'dates' 
                ? 'bg-black text-white' 
                : 'hover:bg-gray-50'
            }`}
      ...
      <AnimatePresence>
        {activeSection === 'destination' && (
          <motion.div
            className="absolute top-full left-0 right-0 mt-4 bg-white rounded-3xl shadow-2xl border border-gray-100 z-50 overflow-hidden"
            ...
            <div className="p-6">
              <div className="space-y-4">
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-2xl focus:border-black focus:outline-none transition-colors text-lg"
                  autoFocus
                />
                <div className="grid grid-cols-2 gap-3">
                  {['New York, NY', 'Los Angeles, CA', 'Chicago, IL', 'Miami, FL'].map((city) => (
                    <motion.button
                      ...
                      className="p-3 text-left rounded-2xl hover:bg-gray-100 transition-colors"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
