...
const PropertyCalendar: React.FC<PropertyCalendarProps> = ({
  ...
  const renderCalendarDay = (day: CalendarDay, index: number) => {
    ...
    const isHovered =
      hoveredDate &&
      format(day.date, 'yyyy-MM-dd') === format(hoveredDate, 'yyyy-MM-dd');
          ...
          <TooltipContent>
            <div className='space-y-1'>
              ...
              <p className='text-sm'>
                ...
                {day.status === 'booked' &&
                  `Booked${day.bookingData?.guest_name ? ` by ${day.bookingData.guest_name}` : ''}`}
          ...
          <div className='mt-4 p-3 bg-blue-50 rounded-lg'>
            <div className='flex items-center gap-2 text-sm text-blue-800'>
              ...
              <span>
                ...
                {rentalType === 'monthly' &&
                  ` Minimum ${minMonths} month${minMonths > 1 ? 's' : ''}.`}
              </span>
            </div>
          </div>
        )}
