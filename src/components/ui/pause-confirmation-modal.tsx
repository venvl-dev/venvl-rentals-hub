        ...
        <AlertDialogHeader>
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Temporarily disable bookings</p>
            </div>
          </div>
        </AlertDialogHeader>
          ...
          <div className="space-y-5">
            <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
              <p className="text-gray-700 font-medium mb-1">
                Pause <span className="font-bold text-gray-900">"{propertyTitle}"</span>?
              </p>
              <p className="text-sm text-gray-500">
                This will temporarily hide it from guests while keeping your data intact.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-5 border border-gray-200">
              ...
              <div className="grid gap-3">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-gray-700 leading-relaxed">Property is hidden from search results</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-gray-400 rounded-full mt-2 flex-shrink-0"></div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-gray-900 font-medium leading-relaxed">You can reactivate it anytime</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-gray-100 to-gray-50 rounded-2xl p-4 border border-gray-200">
              <p className="text-sm text-gray-700 flex items-center gap-3">
                ...
                <span>Perfect for maintenance periods or when you're temporarily unavailable.</span>
              </p>
            </div>
          </div>
        </AlertDialogDescription>
