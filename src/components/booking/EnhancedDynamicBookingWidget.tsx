...
const EnhancedDynamicBookingWidget = ({
  property,
  user,
}: EnhancedDynamicBookingWidgetProps) => {
    ...
    if (pendingBooking && user) {
      try {
        ...
        if (bookingData.propertyId === property.id) {
          ...
          toast.success(
            'Booking restored! You can continue where you left off.',
          );
        }
      } catch (error) {
  ...
  const handleProceedToBooking = () => {
    ...
    const checkIn =
      bookingMode === 'daily' ? selectedDates.from! : monthlyStartDate!;
    const checkOut =
      bookingMode === 'daily'
        ? selectedDates.to!
        ...
        <CardContent className='p-6 space-y-6'>
          ...
          <div className='space-y-4'>
            ...
            <AvailabilityCalendar
              ...
              selectedDates={
                bookingMode === 'daily' ? selectedDates : undefined
              }
            />
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <div className='flex items-center gap-3'>
                    <Button
                      ...
                      size='sm'
                      onClick={() =>
                        setMonthlyDuration(Math.max(1, monthlyDuration - 1))
                      }
                    ...
                    <Button
                      ...
                      size='sm'
                      onClick={() =>
                        setMonthlyDuration(Math.min(12, monthlyDuration + 1))
                      }
          ...
          {!user && (
            <p className='text-xs text-gray-500 text-center'>
              You'll be redirected to login and then back to complete your
              booking
            </p>
          )}
        </CardContent>
