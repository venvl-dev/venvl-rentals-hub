...
import { Download, FileText, Calendar, MapPin, Users, Check } from 'lucide-react';
      ...
      <DialogContent className="max-w-md max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div className="space-y-1">
                ...
                <div className="font-medium">{format(checkIn, 'MMM dd, yyyy')}</div>
              ...
              <div className="space-y-1">
                ...
                <div className="font-medium">{format(checkOut, 'MMM dd, yyyy')}</div>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-gray-50 rounded-lg p-3 space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-lg">{currency} {Math.round(booking.total_price)}</span>
              </div>
              <div className="flex justify-between items-center">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <h4 className="font-medium text-blue-900 mb-2 text-sm">Important Information</h4>
