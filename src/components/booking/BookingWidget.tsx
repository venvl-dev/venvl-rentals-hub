                ...
                {checkIn &&
                  ...
                  differenceInDays(checkOut, checkIn) < property.min_nights && (
                    ...
                    >
                      ...
                      >
                        Minimum {property.min_nights} night
                        {property.min_nights > 1 ? 's' : ''} required
                      </Badge>
                    </motion.div>
                  )}
              </motion.div>
                ...
                {property.min_months && duration < property.min_months && (
                  ...
                  >
                    <Badge
                      ...
                      className='bg-amber-100 text-amber-800 text-xs'
                    >
                      Minimum {property.min_months} month
                      {property.min_months > 1 ? 's' : ''} required
                    </Badge>
                  </motion.div>
                )}
              </motion.div>
                        ...
                        <div className='space-y-2'>
                          ...
                          {duration > 1 && (
                            <div className='text-xs text-blue-600 bg-blue-50 p-2 rounded'>
                              ...
                              <div>
                                • You pay: ${property.monthly_price}/month
                              </div>
                              <div>• Duration: {duration} months</div>
                              <div className='font-semibold'>
                                • Total amount: $
                                {property.monthly_price * duration}
                              </div>
                              <div className='text-xs text-blue-500 mt-1'>
                                * Charged monthly, not upfront
                              </div>
                            </div>
                          )}
                        </div>
