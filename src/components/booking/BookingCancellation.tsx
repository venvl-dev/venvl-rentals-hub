...
const BookingCancellation = ({ booking, onCancel, onSuccess }: BookingCancellationProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { data: canCancel } = await supabase
        .rpc('can_cancel_booking', { booking_id: booking.id });
      ...
      <CardContent className="space-y-6">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <div className="text-sm text-yellow-700 space-y-1">
            ...
            <p><strong>Days until check-in:</strong> {daysUntilCheckIn}</p>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          ...
          <div className="text-sm text-red-700 space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>Cancellations more than 7 days before check-in: Full refund</li>
