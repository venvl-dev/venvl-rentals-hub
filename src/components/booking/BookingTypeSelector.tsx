...
const BookingTypeSelector = ({
  ...
  return (
    <div className='space-y-3'>
        ...
        >
          <div className='w-full'>
            ...
            <div className='flex items-center justify-between text-xs'>
              <span
                className={
                  selectedType === 'daily' ? 'text-gray-300' : 'text-gray-500'
                }
              >
                Short trips
              </span>
        ...
        >
          <div className='w-full'>
            ...
            <div className='flex items-center justify-between text-xs'>
              <span
                className={
                  selectedType === 'monthly' ? 'text-gray-300' : 'text-gray-500'
                }
              >
                Extended stays
              </span>
      ...
      {((selectedType === 'daily' && minNights) ||
        (selectedType === 'monthly' && minMonths)) && (
        <div className='flex items-start gap-2 p-3 bg-blue-50 border border-blue-200 rounded-lg'>
          <Info className='h-4 w-4 text-blue-600 mt-0.5 flex-shrink-0' />
          <div className='text-sm text-blue-800'>
            <span className='font-medium'>Minimum stay: </span>
