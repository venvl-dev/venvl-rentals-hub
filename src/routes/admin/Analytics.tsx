...
const AnalyticsDashboard = () => {
  ...
  const loadAnalyticsData = async () => {
    try {
      ...
      // Load recent trends
      const [dailySignups, weeklySignups, monthlySignups, pendingApprovals] =
        await Promise.all([
          supabase
            .from('profiles')
      ...
      const propertyChange =
        previousPropertyCount === 0
          ? 100
          : ((currentPropertyCount - previousPropertyCount) /
      ...
      const categoryDistribution = Object.entries(typeCount).map(
        ([category, count]) => ({
          category,
          count,
      ...
      const cityStats: Record<
        string,
        { properties: number; bookings: number; revenue: number }
      > = {};
      cityData?.forEach((property) => {
        ...
        cityStats[city].revenue +=
          property.bookings?.reduce(
            (sum: number, booking: any) => sum + Number(booking.total_price),
            0,
          ) || 0;
      });
      ...
      <div className='p-6 space-y-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                {analytics.propertyGrowth.current}
              </div>
              <div className='flex items-center text-xs text-muted-foreground'>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                {analytics.bookingMetrics.totalBookings}
              </div>
              <p className='text-xs text-muted-foreground'>
                Avg: ${analytics.bookingMetrics.averageBookingValue.toFixed(0)}{' '}
                per booking
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                ${analytics.bookingMetrics.totalRevenue.toLocaleString()}
              </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                {analytics.recentTrends.dailySignups}
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                {analytics.recentTrends.weeklySignups}
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                {analytics.recentTrends.monthlySignups}
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold text-orange-600'>
                {analytics.recentTrends.pendingApprovals}
              </div>
              <p className='text-xs text-muted-foreground'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Cities with highest revenue and activity
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Card className='mt-6'>
          <CardHeader>
            ...
            <CardDescription>
              User and property growth over time
            </CardDescription>
          </CardHeader>
          <CardContent>
