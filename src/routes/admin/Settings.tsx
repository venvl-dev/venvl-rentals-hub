        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              ...
              <div>
                <Label htmlFor='minimum_booking_amount'>
              ...
              <div>
                <Label htmlFor='booking_cancellation_hours'>
                  Cancellation Hours
                </Label>
                <Input
            ...
            <CardContent className='space-y-6'>
              ...
              <div className='flex items-center justify-between'>
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateSetting('auto_approve_properties', checked)
                  }
                />
              </div>
            </CardContent>
            ...
            <CardContent className='space-y-4'>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateSetting('admin_notification_email', e.target.value)
                  }
              ...
              <div className='space-y-4'>
                ...
                <div className='flex items-center justify-between'>
                  <div>
                    <Label htmlFor='booking_notification_enabled'>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateSetting('booking_notification_enabled', checked)
                    }
                  />
                </div>
              </div>
            ...
            <CardContent className='space-y-4'>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateSetting('meta_keywords', e.target.value)
                  }
            ...
            <CardContent className='space-y-4'>
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    updateSetting('terms_of_service', e.target.value)
                  }
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    updateSetting('privacy_policy', e.target.value)
                  }
          ...
          <Card className='mt-6 border-orange-200 bg-orange-50'>
            <CardContent className='pt-6'>
              ...
              <p className='text-sm text-orange-700 mt-2'>
                The platform is currently in maintenance mode. Users will not be
